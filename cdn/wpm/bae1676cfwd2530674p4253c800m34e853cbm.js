(() => {
    var e = {
            ...
            1554: function(e, t, n) {
                ...
                ! function(o, i) {
                    ...
                    var s = "function",
                        ...
                        Z = function(e, t) {
                            ...
                            return this.getBrowser = function() {
                                ...
                                var e = {};
                                return e[p] = i, e[h] = i, J.call(e, r, w.os), x && !e[p] && g && "Unknown" != g.platform && (e[p] = g.platform.replace(/chrome os/i, H).replace(/macos/i, q)), e
                    ...
                    Z.VERSION = "1.0.37", Z.BROWSER = W([p, h, l]), Z.CPU = W([v]), Z.DEVICE = W([d, m, f, g, b, w, y, x, _]), Z.ENGINE = Z.OS = W([p, h]), typeof t !== a ? (e.exports && (t = e.exports = Z), t.UAParser = Z) : n.amdO ? (r = function() {
                        return Z
            ...
            1639: (e, t, n) => {
                ...
                e.exports = function(e, t, n) {
                    var v, g, b, y, w, x, _, S = n && n.that,
                        ...
                        O = function(e) {
                            return E ? (i(e), A ? I(e[0], e[1], P) : I(e[0], e[1])) : A ? I(e, P) : I(e)
                        };
                    if (k) v = e.iterator;
                    else if (C) v = e;
                    else {
            ...
            6364: (e, t, n) => {
                ...
                var r = n(9731),
                    ...
                    S = b && m && Object.getOwnPropertyDescriptor(o, v),
                ...
                var C = i(v),
                    A = C.prototype;
                if (A.constructor !== C)
                    for (var I in h || a(A, "constructor", s(1, C)), p)
                        if (c(p, I)) {
                            var P = p[I],
                                O = P.s;
                            c(C, O) || a(C, O, s(6, P.c))
            ...
            8643: (e, t, n) => {
                ...
                p(m, y) || E(y, b), !_ && p(m, g) && m[g] !== Object || E(g, S), S.prototype = m, r({
                    global: !0,
                    constructor: !0,
                    forced: _
                }, {
    ...
    n.amdO = {}, n.n = e => {
            ...
            static handleXhrDone(e) {
                if (!(e.xhr.status >= 400)) try {
                    ...
                    n.match(L) ? q.parsePayloadResponse(e, (t => {
                        ...
                        } else N(e.publish, t, C(e.body), "add-xhr", e.context)
                    })) : n.match(z) ? q.parsePayloadResponse(e, (t => {
                        j(e.publish, t, "change-xhr", e.context)
                    })) : n.match(B) ? q.parsePayloadResponse(e, (t => {
                        D(e.publish, t, "update-xhr", e.context)
                        ...
                        return e.apply(this, Array.prototype.slice.call(o)).then((e => {
                            ...
                            try {
                                if (s.match(L)) {
                                    ...
                                    t.clone().json().then((t => {
                                        j(e, t, "change-fetch", n)
                                    })).catch(M)
                                }(t, e, r) : s.match(B) ? function(e, t, n) {
                                    t.clone().json().then((t => {
                                        D(e, t, "update-fetch", n)
                                    })).catch(M)
        ...
        const V = "visitorConsentCollected",
            F = "p",
            K = "a",
            J = "m",
            X = "t",
        ...
        function oe(e, t) {
            ...
            if (Array.isArray(e)) return `[${e.map((e=>oe(e,!0))).join(",")}]`;
            if ("object" == typeof e) {
                let n = [];
                for (const t in e) e.hasOwnProperty(t) && void 0 !== e[t] && n.push(`${t}:${oe(e[t],!0)}`);
                const r = n.join(",");
                return t ? `{${r}}` : r
            }
        ...
        n(6364);
        const se = () => "undefined" != typeof __CtaTestEnv__ && "true" === __CtaTestEnv__;
        class ae {}
        ae.warn = e => {
            se() || console.warn(e)
        }, ae.error = e => {
        ...
        function le(e, t = !1) {
            ...
            if (t && "_tracking_consent" === e && !window.localStorage.getItem("tracking_consent_fetched")) {
                ...
                return console.debug("_tracking_consent missing"),
                    ...
                    }(), window.localStorage.setItem("tracking_consent_fetched", "true"), le(e, !1)
            }
        }

        function de(e) {
            return e === encodeURIComponent(ie(e))
        }

        function pe(e, t, n, r) {
            if (!de(r)) throw new TypeError("Cookie value is not correctly URI encoded.");
            if (!de(e)) throw new TypeError("Cookie name is not correctly URI encoded.");
            let o = `${e}=${r}`;
        ...
        function fe() {
            const e = function() {
                ...
                return n ? ie(n) : void 0
            }() || new URLSearchParams(window.location.search).get("_cs") || le(ue) || function() {
                try {
                    var e;
        ...
        function Oe(e, t, n) {
            ...
            return fetch(`https://${i}/api/unstable/graphql.json`, a).then((e => {
                ...
                return p && function(e) {
                    ...
                    }(p), r.headlessStorefront && (pe(ue, l, a, p), f && m && (pe(Ae, l, c, f), pe(Ie, l, c, m)), d !== l && (pe(ue, d, a, p), f && m && (pe(Ae, d, c, f), pe(Ie, d, c, m)))), void 0 !== t.granular_consent && function(e) {
                        const t = e[J],
                            n = e[X],
                            r = e[K],
                            o = e[F];
                        ...
                        const i = function(e) {
                            return {
                                ...
                                saleOfDataAllowed: e[X],
                                analyticsAllowed: e[K],
                                preferencesAllowed: e[F],
                                firstPartyMarketingAllowed: e[J],
                                thirdPartyMarketingAllowed: e[X]
                            }
                        }(e);
                        Se(V, i);
                        const s = [r, o, t, n];
                    ...
                    function(e, t) {
                        ...
                        const n = function(e) {
                            const t = new URL(e, window.location.origin),
                                n = ke(e) ? Ee(t) : Ee(t).replace(window.location.origin, "");
                        ...
                        for (const i of Array.from(n)) {
                            ...
                            if (r && n.searchParams.set("consent_id", r), o && n.searchParams.set("consent", o), r || o) {
                                const t = ke(e) ? n.toString() : n.toString().replace(window.location.origin, "");
        ...
        class Te {
            ...
            produce(e, t) {
                if (this.instrumentationEnabled() && we()) try {
                    const n = {
        ...
        function De() {
            ...
            for (const n of Object.keys(t)) e[ve(n)] = he(t[n]);
            return e
        }
        ...
        function Fe() {
            window.Shopify = window.Shopify || {}, window.Shopify.evids || (qe = {}, We = {
                [ze]: {},
                [Be]: {},
                [He]: {}
                ...
                if (! function(e) {
                    ...
                    }(e) || (null == t ? void 0 : t.analyticsFramework) !== Be && "wpm" !== (null == t ? void 0 : t.analyticsFramework) && (null == t ? void 0 : t.analyticsFramework) !== He) return Ve("shu");
                ...
                return function(e, t, n) {
                    var r, o;
                    const i = null !== (r = qe[e]) && void 0 !== r ? r : qe[e] = {},
                        s = null !== (o = i[n]) && void 0 !== o ? o : [];
                    let a = s[t];
                    return a || (a = Ve(), s.push(a)), i[n] = s, a
                }(e, o, n)
            }(...e))
        }
        const Ke = "webPixelsManager",
            ...
            Xe = "0.0.475",
            Ye = "modern",
            Ge = "ae1676cfwd2530674p4253c800m34e853cb",
            Ze = "bae1676cfwd2530674p4253c800m34e853cbm.js";
        ...
        const at = (e, t) => {
                    ...
                    try {
                        const t = it().parse(e).reduce(((e, t) => {
                            const n = function({
                                ...
                                var o;
                                return {
                                    file: `https://cdn.shopify.com/cdn/wpm/${Ze}`,
                                    method: r,
                                    lineNumber: t,
                                    columnNumber: n
                                }
                ...
                const r = function(e, t) {
                    ...
                    try {
                        if (o) {
                            ...
                            if (t && t.length > 2 && (r.lineNumber = t[1], r.columnNumber = t[2], parseInt(r.lineNumber, 10) > 1e5)) throw new st
                        }
                        return {
                            errorClass: e ? .name || n,
                            message: e ? .message || n,
            ...
            ct = ["number", "boolean", "symbol"],
            ut = (e, {
                context: t
            }) => {
                const n = "v1/" + (t ? `${t}/` : "");
                return null == e || ct.includes(typeof e) || Array.isArray(e) ? `${n}UnknownError` : "string" == typeof e ? `${n}${e}` : "groupingHash" in e && "string" == typeof e.groupingHash ? `${n}${e.groupingHash}` : `${n}${"Error"!==e.name&&e.name?e.name:e.message}`
            };
        class lt extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, lt)
            }
        }
        const dt = {
                severity: "error",
            ...
            pt = {
                ...
                notify: (e, t) => {
                    try {
                        ...
                        if (t ? .options ? .sampleRate && !nt(t.options.sampleRate)) return;
                        const n = { ...dt,
                            ...t,
                            ...pt.metadata,
                            shopUrl: self.location.href
                        };
                        if (n.browserTarget === b.NotAvailable || n.browserTarget === b.Unknown || n.surface === m.NotAvailable || n.surface === m.Unknown || !ft(n.shopUrl)) return void(console ? .error && console.error(e));
                        const r = function(e, t) {
                            const {
                                userAgent: n,
                                context: r,
                            ...
                            }(n || self.navigator ? .userAgent), S = at(e, r);
                            return {
                                payload_version: 5,
                                notifier: {
        ...
        function yt(e, t) {
            return e ? !t || Object.keys(e).every((n => !e[n] || t[n])) : Ne()
        }
        ...
        function Nt(e, t = new WeakMap) {
            ...
            for (const [o, i] of Object.entries(e)) {
                ...
                Array.isArray(i) ? r[e] = i.map((e => Nt(e, t))) : Rt(i) ? r[e] = Nt(i, t) : r[e] = i
            }
            return r
        }
        ...
        function qt(e, t = !1) {
            ...
            Bt.push(n), t ? Vt() : void 0 === Ht && (Ht = setTimeout(Vt, 500))
        }
        ...
        function Vt() {
            if (void 0 !== Ht && (clearTimeout(Ht), Ht = void 0), 0 === Bt.length) return;
            const e = [...Bt];
            Bt.length = 0,
                function(e) {
                    ...
                    ! function(e) {
                        const t = Ut;
                        Ut = !1;
                        const n = `${function(e){return{global:"https://monorail-edge.shopifysvc.com",wellKnown:`${Mt}/.well-known/shopify/monorail`,staging:"https://monorail-edge-staging.shopifycloud.com",test:"https://localhost"}[e||"wellKnown"]}(zt)}/unstable/produce_batch`;
                        try {
        ...
        function Yt() {
            if (!Jt && (Jt = "undefined" != typeof crypto && crypto.getRandomValues && crypto.getRandomValues.bind(crypto), !Jt)) throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");
            return Jt(Xt)
        }
        const Gt = [];
        for (let n = 0; n < 256; ++n) Gt.push((n + 256).toString(16).slice(1));
        const Zt = function(e, t, n) {
            if (Kt.randomUUID && !t && !e) return Kt.randomUUID();
            const r = (e = e || {}).random || (e.rng || Yt)();
        ...
        const rn = e => "number" == typeof e ? new nn(e) : new Map,
            on = (...e) => JSON.stringify(e);
        ...
        const an = sn(((e = "") => {
            ...
            dn = e => {
                const t = un();
                return t ? cn(t)[e] : void 0
            },
            pn = "_shopify_test",
            fn = new Map;
        const mn = () => dn("_shopify_y") ? ? "";
        ...
        const yn = Symbol.for("RemoteUi::Retain"),
            wn = Symbol.for("RemoteUi::Release"),
        ...
        class _n {
            ...
            add(e) {
                this.memoryManaged.add(e), e[xn].add(this), e[yn]()
            }
            release() {
                for (const e of this.memoryManaged) e[xn].delete(this), e[wn]();
                this.memoryManaged.clear()
            }
        }

        function Sn(e) {
            return Boolean(e && e[yn] && e[wn])
        }
        ...
        function An(e, t, n) {
            ...
            if (null != r) return r;
            const o = Sn(e);
            if (o && e[wn](), n.set(e, o), t) {
                if (Array.isArray(e)) {
                    const r = e.reduce(((e, r) => An(r, t, n) || e), o);
                    return n.set(e, r), r
                }
                if (In(e)) {
                    const r = Object.keys(e).reduce(((r, o) => An(e[o], t, n) || r), o);
                    return n.set(e, r), r
                }
            }
            return o
        ...
        function On(e) {
            ...
            function o(t, n) {
                if ("object" == typeof t) {
                    ...
                    if (In(t)) return Object.keys(t).reduce(((e, r) => ({ ...e,
                        [r]: o(t[r], n)
                    })), {})
                }
                return t
        ...
        const Dn = (e, t, {
            ...
            jn = "web-pixels-helper-sandbox-handle",
            $n = {
                height: "26px",
                width: "21px",
                top: "12px",
        ...
        async function Bn({
            ...
            if (s) {
                if (t.privileges) {
                    if (! function(e) {
                            return "sandbox" in e
                        }(i)) throw new lt("browser does not support the sandbox attribute on IFrames");
        ...
        async function Hn({
            ...
            const r = await async function({
                    ...
                    const r = `${e}/web-pixels-helper/h${Ge}m.html`;
                    return Bn({
                        containerSpec: {
            ...
            return o.expose(function({
                                ...
                                function(e, t) {
                                    if ((new Te).produce("setTrackingConsent", "v0.2"), function(e) {
                                            ...
                                            if ("object" == typeof e) {
                                                ...
                                                const n = [ee, te, ne, re, "email", "rootDomain", "checkoutRootDomain", "storefrontRootDomain", "storefrontAccessToken", "headlessStorefront", "isExtensionToken", "metafields"];
                                                for (const e of t)
                ...
                function(e, t) {
                    if (e.querySelector(`#${jn}`)) return;
                    const n = document.createElement("div");
                    n.setAttribute("id", jn), Dn(n, {
                        display: "block",
                        position: "absolute",
                        cursor: "grab",
                        background: "transparent",
                        ...
                        function o(t) {
                            t.preventDefault();
                            const o = Un,
                                i = self.innerHeight - Un,
                                s = Un,
                                a = self.innerWidth - Un;
                            if (t.clientY < o || t.clientY > i || t.clientX < s || t.clientX > a) return;
                            n && n(t.clientX - Un, t.clientY - Un), r[1] = r[3] - t.clientX, r[2] = r[4] - t.clientY, r[3] = t.clientX, r[4] = t.clientY;
                        ...
                        return e => {
                            e.preventDefault(), r[3] = e.clientX, r[4] = e.clientY, self.addEventListener("mouseup", i), self.addEventListener("mousemove", o), Dn(t, Mn, {
                                important: !0
                            })
                        }
                    }({
        ...
        const Jn = [h.Custom, h.App];

        function Xn(e) {
            try {
                sessionStorage.setItem(Vn, JSON.stringify(e))
            } catch {
                t = "Session storage is not available. The Pixel Helper experience may be degraded.", Wn.has(t) || (Wn.add(t), "console" in self && console.warn(t))
            }
            var t
        }

        function Yn() {
            Qe((() => sessionStorage.removeItem(Vn)))
        }
        const Gn = (e, t) => ({
                version: Xe,
                    ...
                    async init(n) {
                            ...
                            try {
                                return (e => {
                                    const t = new URL(window.location.href),
                                        n = t.searchParams.get(Vn),
                                        r = Qe((() => n ? JSON.parse(atob(n)) : null), null);
                                    n && (t.searchParams.delete(Vn), self.history.replaceState(null, "", t.toString()));
                                    const o = Qe((() => JSON.parse(sessionStorage.getItem(Vn) ? ? "null")), null);
                                    if (!r && !o) return null;
                                    const i = {
                                        position: null,
                                        height: 216,
                                    ...
                                    if (!s || !Jn.includes(s.type) || s.id.match(/shopify/i)) throw Yn(), new Kn(i, i.pixel);
                                ...
                                }), Wt("helperLoad", Gn(n, "helper-read-error"))
                            }
                            return null
                        })();
                        if (!r) return;
                        ...
                        await Hn({
                            ...
                            this.message("initializeHelper", {
                                ...
                                loggerLevel: Qe((() => "true" === self.localStorage.getItem("pixel-helper-advanced") ? qn.Advanced : qn.Standard), qn.Standard)
                            ...
                            pt.notify(e, {
                                ...
                                unhandled: !1,
                                severity: "warning"
                            }), Wt("helperLoad", Gn(n, "helper-create-error"))
                        }))
                    }
                }
            }();
        class Qn {
            constructor({
                ...
                this.channelSubscribers = new Map, this.replayQueue = void 0, this.bufferSize = void 0, this.replayKeep = void 0, this.subscribeAllKey = void 0, this.onSubscriberError = void 0, this.middlewareChain = void 0, this.bufferSize = e, this.replayKeep = t, this.subscribeAllKey = n, this.replayQueue = new vn(e, t), this.onSubscriberError = r, this.middlewareChain = e => e()
            }
            use(...e) {
        ...
        const or = "[object Undefined]",
            ir = "[object Null]",
            sr = ["[object String]", "[object Number]", "[object Boolean]", or, ir],
            ar = e => null === e ? ir : void 0 === e ? or : Object.prototype.toString.call(e);
        ...
        function cr(e) {
            ...
            return void 0 === e || r(e) ? {
                isValid: function e(o, i = "root") {
                    ...
                    const s = ar(o),
                        a = sr.includes(s);
                    return a || (n = i, t = `Value of type "${s}" at "${n}" must be one of the following types: ${sr.join(", ")}.`), a
                }(e, "root"),
                error: t,
                errorKey: n
            } : (n = "root", t = `Value of type "${ar(e)}" at "${n}" must be an object.`, {
                isValid: !1,
                error: t,
                errorKey: n
            })
        ...
        function lr() {
            document.removeEventListener("visibilitychange", lr);
            for (const e of ur) e();
            ur.clear()
        }
        ...
        function dr() {
            return new Promise((e => {
                ur.add(e), "visible" === document.visibilityState ? (document.addEventListener("visibilitychange", lr), requestAnimationFrame((() => setTimeout((() => {
                    ur.delete(e), e()
                }))))) : lr()
            }))
        }
        const pr = sn((e => {
            ...
            fr = ["page_viewed", "product_viewed", "collection_viewed", "cart_viewed", "clicked", "form_submitted", "input_blurred", "input_focused", "input_changed", "advanced_dom_clicked", "advanced_dom_scrolled", "advanced_dom_window_resized"];

        function mr(e, t, n) {
            try {
                if (!fr.includes(e.name)) return;
                const r = dn("_shopify_s") || "";
                (function(e, t) {
                    if (!t) return !1;
                    return pr(t.toLowerCase()) % 100 + 1 <= 1
                })(0, r) && Wt("buyerEventSample", {
                    shopId: t,
                    eventType: e.type,
                    eventName: e.name,
                    surface: n,
        ...
        function hr() {
            return {
                document: {
                    location: {
                        href: Qe((() => window ? .location ? .href), ""),
                        hash: Qe((() => window ? .location ? .hash), ""),
                        host: Qe((() => window ? .location ? .host), ""),
                        hostname: Qe((() => window ? .location ? .hostname), ""),
                        origin: Qe((() => window ? .location ? .origin), ""),
                        pathname: Qe((() => window ? .location ? .pathname), ""),
                        port: Qe((() => window ? .location ? .port), ""),
                        protocol: Qe((() => window ? .location ? .protocol), ""),
                        search: Qe((() => window ? .location ? .search), "")
                    },
                    referrer: Qe((() => document ? .referrer), ""),
                    characterSet: Qe((() => document ? .characterSet), ""),
                    title: Qe((() => document ? .title), "")
                },
                navigator: {
                    language: Qe((() => navigator ? .language), ""),
                    cookieEnabled: Qe((() => navigator ? .cookieEnabled), !1),
                    languages: Qe((() => navigator ? .languages), []),
                    userAgent: Qe((() => navigator ? .userAgent), "")
                },
                window: {
                    innerHeight: Qe((() => window ? .innerHeight), 0),
                    innerWidth: Qe((() => window ? .innerWidth), 0),
                    outerHeight: Qe((() => window ? .outerHeight), 0),
                    outerWidth: Qe((() => window ? .outerWidth), 0),
                    pageXOffset: Qe((() => window ? .pageXOffset), 0),
                    pageYOffset: Qe((() => window ? .pageYOffset), 0),
                    location: {
                        href: Qe((() => window ? .location ? .href), ""),
                        hash: Qe((() => window ? .location ? .hash), ""),
                        host: Qe((() => window ? .location ? .host), ""),
                    ...
                    origin: Qe((() => window ? .origin), ""),
                    screen: {
                        height: Qe((() => window ? .screen ? .height), 0),
                        width: Qe((() => window ? .screen ? .width), 0)
                    },
                    screenX: Qe((() => window ? .screenX), 0),
                    screenY: Qe((() => window ? .screenY), 0),
                    scrollX: Qe((() => window ? .scrollX), 0),
                    scrollY: Qe((() => window ? .scrollY), 0)
                }
            }
        }
        const vr = new Map,
            gr = e => {
                const t = (vr.get(e) ? ? 0) + 1;
                return vr.set(e, t), t
            },
            br = e => ({ ...e,
                get clientId() {
                ...
                context: hr(),
                id: "string" == typeof e.id && e.id.length > 0 ? e.id : Zt(),
                seq: gr(e.name)
            });
        ...
        n(2341);
        const xr = "wpmLoggedConversion1",
            _r = ["thank_you", "thank-you", "post_purchase", "post-purchase"];
        class Sr extends f {
            constructor(e) {
        ...
        const Ar = /^\/checkouts\/([^/]+)\/([^/]+)(?:\/((?:[a-z]{2,3}|zh-hans|zh-hant)(?:-[a-zA-Z0-9]+)?))?(?:\/([^/]+))\/?$/,
            Ir = (e, t, n, r, o) => {
                const {
        ...
        function Tr(e, t, n, r = new WeakMap) {
            ...
            if (Array.isArray(e)) {
                const o = [];
                r.set(e, o);
                for (let i = 0; i < e.length; i++) o[i] = Tr(e[i], t, n, r);
                return o
            }
            if (!(Object.keys(t).length > 0)) return r.set(e, e), e;
            const o = { ...e
            };
            r.set(e, o);
            for (const i in t) i in o && (o[i] = Tr(e[i], t[i], n, r));
            return o
        }
        const Rr = {
                data: {
                    checkout: {
                        email: (e, {
                            protectedCustomerApprovalScopes: t
                        }) => t.read_customer_email ? e : null,
                        phone: (e, {
                            protectedCustomerApprovalScopes: t
                        }) => t.read_customer_phone ? e : null,
                        smsMarketingPhone: (e, {
                            protectedCustomerApprovalScopes: t
                        }) => t.read_customer_phone ? e : null,
                        billingAddress: {
                            ...
                            address1: (e, {
                                protectedCustomerApprovalScopes: t
                            }) => t.read_customer_address ? e : null,
                            address2: (e, {
                                protectedCustomerApprovalScopes: t
                            }) => t.read_customer_address ? e : null,
                            zip: (e, {
            ...
            Nr = {
                checkout_address_info_submitted: Rr,
                checkout_completed: Rr,
                checkout_contact_info_submitted: Rr,
                checkout_shipping_info_submitted: Rr,
                checkout_started: Rr,
                payment_info_submitted: Rr
            };
        class Dr extends f {
            constructor(e, t) {
        ...
        function Lr(e) {
            const {
                ...
                if (r && "string" == typeof r || (e(new Er, {
                    ...
                    }()), !r || "string" != typeof r) return e(new kr, {
                    severity: "info",
                    unhandled: !1,
                    context: "isExcludedDuplicateConversion"
                }), !1;
                if (! function() {
                        try {
                            ...
                            return e.includes("checkouts") && e.some((e => _r.includes(e)))
                        } catch (e) {
                            return !1
                        }
                    }()) return !1;
                const o = function() {
                    try {
                        ...
                        return "object" != typeof t || null === t ? {} : Cr(t)
                    } catch (e) {
                        return {}
                    }
                }();
                return r in o ? (e(new Sr(r), {
                    severity: "info",
                    unhandled: !1,
                    context: "isExcludedDuplicateConversion"
                }), !0) : (function(e, t) {
                ...
                if (!_t(Et)) return void t();
                const {
                    dataSharingAdjustments: s,
                    id: a
                } = i ? .pixelRuntimeConfig || {};
                if (!s ? .protectedCustomerApprovalScopes) return void t();
                const c = Nr[n] ? ? null;
                if (c) try {
                    t(Tr(r, c, Or(s)))
                } catch (u) {
                    e.logError(new Dr(n, u instanceof Error ? u : new Error(String(u))), {
            ...
            return {
                publish(e, v, g) {
                    if (!_t(St) && n !== m.CustomerAccount) return function(e, s, a) {
                        if ("string" != typeof e) throw new Ur("Expected event name to be a string, but got " + typeof e, "LegacyPublishStandardEventError");
                        if (!u(e)) return !1;
                        const c = cr(s);
                        if (!c.isValid) return console.error(c.error), !1;
                        const l = yr(e, s, a),
                            d = l.data ? .checkout ? .token;
                        return mr(l, t, n), Wt("eventPublish", {
                            version: Xe,
                            bundleTarget: Ye,
                            pageUrl: self.location.href,
                            shopId: t,
                    ...
                    if ("string" != typeof e) {
                        ...
                        throw new Ur(`Expected event name "${t}" to be a string, but got ${typeof e}`, "PublishEventError")
                    }
                    if (function(e) {
                            return c(e) === s.Meta
                        }(e)) return !1;
                    ...
                    if (!b.isValid) {
                        if (d(e) || p(e)) {
                            const t = new Ur(`Input Validation Error for event ${e}: ${b.error}\nPayload: ${JSON.stringify(v)}`, "PublishAdvancedDomEventError");
                            if (n === m.StorefrontRenderer) return pt.notify(t, {
                                type: "metric",
                    ...
                    let y;
                    if (y = l(e) ? wr(e, v) : yr(e, v, g), l(e) || u(e)) {
                        let r = {
                            version: Xe,
                            bundleTarget: Ye,
                            pageUrl: self.location.href,
                ...
                publishCustomEvent(e, r, o) {
                    if (_t(St)) return this.publish(e, r, o);
                    if ("string" != typeof e) throw new Ur("Expected event name to be a string, but got " + typeof e, "PublishCustomEventError");
                    if (!l(e)) return !1;
                    const i = cr(r);
                ...
                publishDomEvent(e, r, o) {
                    ...
                    if ("string" != typeof e) {
                        const t = JSON.stringify(e);
                        throw new Ur(`Expected event name "${t}" to be a string, but got ${typeof e}`, "PublishDomEventError")
                    }
                    if (!d(e) && !p(e)) throw new Ur(`Event name "${e}" is not a supported DOM Event`, "PublishDomEventError");
                    const i = cr(r);
                    if (!i.isValid) {
                        const t = new Ur(`Input Validation Error for event ${e}: ${i.error}`, "PublishDomEventError");
                        if (n === m.StorefrontRenderer) return pt.notify(t, {
                            type: "metric",
                    ...
                    const s = yr(e, r, o);
                    return mr(s, t, n), p(e) ? h.publish(e, s) : f.publish(e, s)
                },
                subscribe(e, t, r = {}) {
                    const o = Zt(),
                        l = async i => {
                            if (n === m.CheckoutOneSdk && r.scope !== er.CheckoutOneSdk) return;
                            await dr();
                            const a = {
                            ...
                            let d;
                            try {
                                await t.call(i, i), Zn.message("logEvent", l)
                            } catch (g) {
                                d = g, Zn.message("logEvent", { ...l,
                                    status: "FAIL",
                                    error: d
                                })
                            }
                            const p = c(i.name),
                                ...
                                h = d ? "FAILURE" : "SUCCESS",
                                v = d ? String(d) : void 0;
                            if ([s.Dom, s.AdvancedDom].includes(p)) nt(1) && Wt("subscriberEventEmitDom", { ...f,
                                status: h,
                                errorMessage: v
                            });
                            else {
                                let e;
                                u(i.name) && (e = i ? .data ? .checkout ? .token), Wt("subscriberEventEmit", { ...f,
                                    eventType: p,
                    ...
                    if ("all_events" === e) {
                        const e = i.subscribe(jr, l, r),
                            t = a.subscribe($r, l, r),
                            n = f.subscribe(Mr, l, r);
                        return () => {
                            const r = e(),
                                o = t(),
                                i = n();
                    ...
                    return e === $r ? a.subscribe($r, l, r) : e === jr || u(e) ? i.subscribe(e, l, r) : e === Mr || d(e) ? f.subscribe(e, l, r) : a.subscribe(e, l, r)
                }
            }
        }
        const zr = ["31014027265", "28638674945", "44186959873"],
            Br = {
                customer: {
                    email: (e, {
                        protectedCustomerApprovalScopes: t
        ...
        function qr(e, t) {
            const n = {
                ...
                data: {
                    ...
                    cart: (o = e.cart, o ? {
                        ...
                        cost: {
                            totalAmount: {
                                amount: o ? .cost ? .totalAmount ? .amount,
                                currencyCode: o ? .cost ? .totalAmount ? .currencyCode
                            }
                        },
                        lines: o ? .lines,
                    ...
                    shop: e.shop,
                    purchasingCompany: (r = e.purchasingCompany, r ? {
                        company: r.company,
                        location: r.location
                    } : null)
                },
            ...
            const s = function(e, t) {
                ...
                try {
                    ...
                    return pt.notify(new Hr(o instanceof Error ? o : new Error(String(o))), {
        ...
        function Fr({
            ...
            const c = function(e) {
                return e === m.Shopify || e === m.CheckoutOne || e === m.CheckoutOneSdk ? tr.Checkout : e === m.StorefrontRenderer ? tr.Storefront : tr.Unknown
            }(o);
            return {
                analytics: {
                    subscribe(t, i, a) {
                ...
                browser: {
                    ...
                    sendBeacon: async (e, t = "") => {
                        ...
                        return Qe((() => window.navigator.sendBeacon(e, n)), !1)
                    },
                    localStorage: {
                        setItem: async (e, t) => {
                            Qe((() => window.localStorage.setItem(e, t)))
                        },
                        getItem: async e => Qe((() => window.localStorage.getItem(e)), null),
                        key: async e => Qe((() => window.localStorage.key(e)), null),
                        removeItem: async e => {
                            Qe((() => window.localStorage.removeItem(e)))
                        },
                        clear: async () => {
                            Qe((() => window.localStorage.clear()))
                        },
                        length: async () => Qe((() => window.localStorage.length), 0)
                    },
                    sessionStorage: {
                        setItem: async (e, t) => {
                            Qe((() => window.sessionStorage.setItem(e, t)))
                        },
                        getItem: async e => Qe((() => window.sessionStorage.getItem(e)), null),
                        key: async e => Qe((() => window.sessionStorage.key(e)), null),
                        removeItem: async e => {
                            Qe((() => window.sessionStorage.removeItem(e)))
                        },
                        clear: async () => {
                            Qe((() => window.sessionStorage.clear()))
                        },
                        length: async () => Qe((() => window.sessionStorage.length), 0)
                    }
                },
                settings: a,
                init: qr(i, n),
        ...
        async function Qr(e) {
            ...
            const {
                ...
                shopId: i,
                surface: s
            } = e, a = r.id, c = r.type.toLowerCase(), u = kt.WebPixels;
            var l, d;
            switch (r.restrictions || (r.restrictions = function(e, t) {
                const n = {};
                return zr.includes(String(e)) && (n.allowedEvents = [], t !== m.StorefrontRenderer && (n.preventLoadingBeforeEvent = `shopify:app:pixels:load:${e}`)), n
            }(String(r.apiClientId), s)), await Promise.all([(async () => {
                await wt(function(e) {
                    if (e) return bt.reduce(((t, n) => (t[n] = e.includes(n.toUpperCase()), t)), {})
                }(r.privacyPurposes)), Zn.message("logConsentGranted", {
                    pixelUid: {
                        id: a,
                        type: r.type
                    }
                ...
                case v.Strict:
                    try {
                        t = await async function({
                            ...
                            const u = `web-pixel-sandbox-${e.type}-${e.id}-${e.runtimeContext}-${Ge}`;
                            if (e.runtimeContext === v.Lax && document.getElementById(u)) {
                                const t = new Xr;
                                throw pt.notify(t, {
                                    type: "metric",
                                    pixelId: e.id,
                            ...
                            switch (e.runtimeContext) {
                                case v.Strict:
                                    [l, d] = await async function({
                                        ...
                                        const o = t.id,
                                            i = [Dt(n), `/${r}`, `@${Ge}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", `/worker.${Ye}.js`];
                                        ...
                                        const s = i.join(""),
                                            ...
                                            c = new Promise(((e, t) => {
                                                const n = e => {
                                                    a.removeEventListener("error", n), t(e ? .filename && e ? .lineno && e ? .message ? new Kr(e.message, s) : new f(`Failed to load web worker for pixel ${o} with url ${s}}`, {
                                ...
                                case v.Lax:
                                    [l, d] = await async function({
                                        ...
                                        const {
                                            search: o
                                        } = self.location, i = t.id, s = t.type.toLowerCase(), a = [Dt(n), `/${r}`, `@${Ge}`, `/${s}`, `/web-pixel-${i}`, `@${t.scriptVersion}`, "/sandbox", `/${Ye}`, /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, o];
                                        if (n.match(/spin\.dev\/?/)) {
                                            const e = o.length ? "&" : "?";
                                        ...
                                        const p = () => {
                                            d = setTimeout((() => {
                                                l(new f(`Failed to load iframe for pixel ${i} with url ${a.join("")}}`, {
                                    ...
                                    break;
                                default:
                                    throw new f(`Unsupported runtime context: ${e.runtimeContext}`, {
                            ...
                            const b = e.runtimeContext === v.Lax ? (Jr || (Jr = {
                            ...
                            if (d && y.push(d), await Promise.race(y), Ge !== g.hashVersion) {
                                const t = new f(`The main bundle hash (${Ge}) does not match the sandbox hash (${g.hashVersion})`, {
                    ...
                    try {
                        t = await async function({
                            ...
                            const {
                                ...
                                type: p,
                                integrityHash: m
                            } = e, h = `${d}-${p}`.toLowerCase(), v = _t("72028870");
                            Zr.set(h, (() => ({
                                webPixelApi: Fr({
                                    eventBus: t,
                                    customerPrivacyEventBus: n,
                            ...
                            const g = o.match(/spin\.dev\/?/),
                                b = [Dt(o), `/${a}@${Ge}`, `/${e.type.toLocaleLowerCase()}`, `/web-pixel-${d}@${e.scriptVersion}`, v ? "~2" : "", `/pixel.${Ye}.js`, g ? "?fast_storefront_renderer=1" : ""].join("");
                            if (!self[Ke]) {
                                const e = new f(`${Ke} was not found on the global scope. ${Ke}.createShopifyExtend() was not exposed to the window.`, {
                            ...
                            if (!("createShopifyExtend" in self[Ke])) {
                                const e = (e, t) => {
                                    ...
                                    if (r && o || (r = e, o = t), !r || !o) return l(new f("No pixelId or pixelType found in script tag or params.", {
                                        groupingHash: "WebPixelOpen:NoPixelIdOrType"
                                    })), null;
                                    const i = `${r}-${o}`.toLowerCase(),
                                        s = Zr.get(i);
                                    if (!s) return l(new f(`No openPixelFn found for ${i}.`, {
                                    ...
                                    return u || c(new f(`No api found for pixel ${i}.`, {
                                        groupingHash: "WebPixelOpen:NoApiFound"
                                    })), Object.freeze({
                                        extend: (e, t) => {
                                            "WebPixel::Render" !== e && c(new Gr(`Invalid extension point: ${e}`, {
                                ...
                                tn(self[Ke], "createShopifyExtend", {
                                    value: e,
                                    enumerable: !1,
                                    writable: !1,
                                    configurable: !1
                            ...
                            var w, x;
                            return await (w = b, x = e => {
                                e.dataset.pixelId = d, e.dataset.pixelType = p, v && (m ? (e.integrity = m, e.crossOrigin = "anonymous") : pt.notify(new f(`Missing integrityHash for SRI-enabled open pixel of type ${p} with id ${d} and src ${b}`, {
                                ...
                                try {
                                    ...
                                    n.src = w, n.async = !0, n.onload = () => {
                                        ...
                                        r(), t(new f(`Failed to load script: ${w}`, {
                                    ...
                                    x && x(n), document.head.appendChild(n)
                                } catch (y) {
                                    t(y)
                                }
                            }))), c
                ...
                default:
                    {
                        const e = new f(`Invalid runtimeContext: ${r.runtimeContext}`, {
                            groupingHash: "WebPixel:InvalidRuntimeContext"
                        });
                        throw Zn.message("logPixelRegister", {
                            pixelUid: {
                                id: a,
                                type: r.type
                            },
            ...
            n && !t ? Zn.message("logPixelRegister", {
                pixelUid: {
                    id: a,
                    type: r.type
                },
                status: "FAIL",
                errorType: n instanceof Yr ? "PixelInitializationError" : "PixelRegistrationError",
                error: n
            }) : t && Zn.message("logPixelRegister", {
                pixelUid: {
                    id: a,
                    type: r.type
                },
        ...
        let eo;
        const to = () => (void 0 === eo && (eo = function() {
                let e = !1;
                try {
                    const t = {
                            get passive() {
        ...
        function ro(e, t, n, r = {}) {
            const o = r.addEventListenerOptions ? { ...no,
            ...
            try {
                ...
                return e.addEventListener(t, i, to() ? o : o.capture), () => {
                    e.removeEventListener(t, i, to() ? o : o.capture)
                }
            } catch (i) {
                pt.notify(i, {
        ...
        const oo = new RegExp(["password", "pass", "pw", "ssn", "sin", "social", "security", "cc", "card", "creditcard", "cvv", "cvc", "cvn", "billing", "license", "health", "secret", "unique"].map((e => `^(.*[^a-z])?${e}([^a-z].*)?$`)).join("|"), "i"),
            io = function(e, {
                cache: t,
                cacheKey: n
            } = {}) {
                ...
                return !!Ln(e) && null !== e.closest('script, iframe, [data-shopify-privacy="exclude"]')
            }), {
                cacheKey: e => e
            }),
            so = ["id", "name", "type"],
        ...
        function co(e, t, n) {
            const r = t.reduce(((t, r) => {
                const o = function(e, t, n) {
                    if (t in e) try {
                        const n = e[t];
                        if (ao.includes(typeof n)) return n
                    } catch (r) {
                        pt.notify(r, {
            ...
            return ((e, t) => {
                "value" in t && "string" == typeof t.value && (e => {
                    ...
                    return "redact" === t || so.some((t => {
                        const n = e.getAttribute(t);
                        return "string" == typeof n && n.match(oo)
                    }))
                })(e) && (t.value = "******")
            })(e, r), r
        }
        ...
        const fo = ["screenX", "screenY", "pageX", "pageY", "clientX", "clientY", "offsetX", "offsetY", "movementX", "movementY"],
            mo = fo.reduce(((e, t) => (e[t] = 0, e)), {});
        let ho = 0;
        ...
        function go(e) {
            if (!e) return -1;
            let t = vo.get(e);
            return void 0 === t && (t = ho, vo.set(e, t), ho += 1), t
        }
        ...
        function yo(e) {
            ...
            if (!bo.has(e)) {
                ...
                for (; t && io(t);) t = t.previousSibling;
                bo.set(e, {
                    parentSerializationId: go(e.parentNode),
                    prevSiblingSerializationId: go(t)
                })
            }
            return bo.get(e)
        }
        ...
        const xo = ["checkbox", "radio"];

        function _o(e) {
            const t = {
                nodeType: e.nodeType,
                serializationId: go(e)
            };
            if (e instanceof Element) {
                ...
                if (n.push("value"), t.attributes = co(e, n), e instanceof HTMLInputElement && xo.includes(e.type)) {
        ...
        const Eo = [HTMLInputElement, HTMLSelectElement, HTMLTextAreaElement, HTMLButtonElement],
            ko = ["id", "name", "tagName", "type", "value"];
        ...
        const Ao = (e, t) => (n, {
                ...
                try {
                    const e = o ? .target;
                    if (!(e instanceof HTMLInputElement || e instanceof HTMLSelectElement || e instanceof HTMLTextAreaElement) || io(e)) return;
                    r ? n(`${r}${t}`, {
                        node: _o(e)
                    }) : n(t, {
                        element: Co(e)
            ...
            Io = Ao("blur", "input_blurred"),
            Po = Ao("focus", "input_focused"),
            Oo = Ao("change", "input_changed"),
            To = ["action", "id"],
            Ro = [Io, Oo, (e, {
                eventPrefix: t
            } = {}) => ro(self.window, "click", (n => {
                const r = n ? .target;
                if (!(r instanceof Element) || io(r)) return;
                const o = t ? So(n, r) : function(e, t) {
                    return {
                        element: po(t),
                        ...mo,
                        ...hn(e, fo)
                ...
                const r = n ? .target;
                r instanceof HTMLFormElement && !io(r) && (t ? e(`${t}form_submitted`, {
                    node: _o(r)
                }) : e("form_submitted", {
                    element: { ...co(r, To),
                        elements: Array.from(r.elements).filter((e => Eo.some((t => e instanceof t)) && !io(e))).map((e => Co(e)))
                    }
                }))
            }))],
            No = (e, t) => {
        ...
        const jo = (e, t) => Array.from(e).reduce(((e, n) => (io(n) || e.push(t(n)), e)), []),
            $o = e => ({
                node: _o(e),
                children: jo(e.childNodes, $o),
                ...yo(e)
            }),
            Mo = [e => {
                let t = null;
                return ro(self.window, "mousemove", (n => {
                ...
                io(r) || e("advanced_dom_scrolled", {
                    node: _o(r)
                })
            }), {
                throttleDelay: 100
            }), e => {
                const t = [Do("cut", e), Do("paste", e), Do("copy", e)];
                return () => {
                    t.forEach((e => e()))
                }
            }, e => ro(self.document, "selectionchange", (t => {
                const n = document.activeElement;
                n instanceof Element && !io(n) && e("advanced_dom_selection_changed", {
                    node: _o(n)
                })
            }), {
                throttleDelay: 250
                ...
                const t = () => {
                    e("advanced_dom_available", {
                        root: $o(self.document)
                    })
                };
                return "loading" !== document.readyState ? (t(), () => {}) : ro(self.window, "DOMContentLoaded", t)
            }, e => {
                const t = new MutationObserver((async t => {
                    await dr(), t.forEach((t => {
                        if (io(t.target)) return;
                        const n = jo(Array.from(t.addedNodes).filter((e => e.parentNode)), $o),
                            r = function(e) {
                                if (0 === e.removedNodes.length) return [];
                                if (io(e.target)) return e.removedNodes.forEach((e => wo(e))), [];
                        ...
                        if ("attributes" === t.type) {
                            ...
                            n && e instanceof HTMLElement && t.oldValue !== e.getAttribute(n) && o.push(_o(t.target))
                        }
                        if ("characterData" === t.type) {
                            const {
                                target: e
                            } = t;
                            e instanceof Text && t.oldValue !== e.data && o.push(_o(e))
                        }
        ...
        class zo {
            constructor(e, {
                ...
                this.eventBus = void 0, this.eventBus = new Qn({
                    subscribeAllKey: "*",
                    onSubscriberError: t
                });
        ...
        class Fo {
            constructor(e, {
                ...
                Object.defineProperty(this, Wo, {
                    ...
                    writable: !0,
                    value: void 0
                }), Bo(this, Wo)[Wo] = e, Bo(this, Vo)[Vo] = t
            }
            register(e) {
                Bo(this, Vo)[Vo] === m.CustomerAccount && e("log:event-bus:publish", (({
                    payload: {
                        event: e
                    }
                }) => {
        ...
        class Xo {
            constructor(e, t) {
                Object.defineProperty(this, Ko, {
                    ...
                    writable: !0,
                    value: void 0
                }), Bo(this, Ko)[Ko] = e, Bo(this, Jo)[Jo] = t
            }
            track(e) {
                Bo(this, Ko)[Ko]($t("firstPartyTracking", {
                    source: "web-pixels-manager",
                    shopId: Bo(this, Jo)[Jo].shopId,
                    isMerchantRequest: Bo(this, Jo)[Jo].isMerchantRequest,
                    apiClientId: 5677769,
                    analyticsAllowed: Bo(this, Jo)[Jo].analyticsProcessingAllowed(),
                    marketingAllowed: Bo(this, Jo)[Jo].marketingAllowed(),
                    preferencesAllowed: Bo(this, Jo)[Jo].preferencesProcessingAllowed(),
                    saleOfDataAllowed: Bo(this, Jo)[Jo].saleOfDataAllowed(),
                    ...e
                }))
            }
        }
        const Yo = ["checkout_completed", "checkout_started", "payment_info_submitted", "checkout_shipping_info_submitted", "checkout_contact_info_submitted", "checkout_address_info_submitted"],
            Go = new Set([...Yo, "page_viewed", "product_viewed", "collection_viewed", "product_added_to_cart", "search_submitted"]),
            Zo = {
        ...
        class ni {
            constructor(e, {
                ...
                Object.defineProperty(this, ei, {
                    ...
                    writable: !0,
                    value: void 0
                }), Bo(this, ei)[ei] = e, Bo(this, ti)[ti] = t
            }
            register(e) {
                e("log:event-bus:publish", (({
                    ...
                    const {
                        ...
                        uniqueToken: e.clientId,
                        eventSourceUrl: t.document.location.href,
                        surface: Bo(this, ti)[ti],
                        userAgent: t.navigator.userAgent,
                        sessionId: en(),
                        referrer: t.document.referrer
                    };
                    if ((e => Yo.includes(e.name))(e)) {
                        const {
                            checkout: t
                        } = e.data;
                        Bo(this, ei)[ei].track({ ...n,
                            eventName: e.name,
                    ...
                    } else if ("page_viewed" === e.name) Bo(this, ei)[ei].track({ ...n,
                        eventName: Qo(e.name),
                        referrer: t.document.referrer
                    });
        ...
        class ii {
            constructor(e, t) {
                Object.defineProperty(this, ri, {
                    ...
                    writable: !0,
                    value: void 0
                }), Bo(this, ri)[ri] = e, Bo(this, oi)[oi] = t
            }
            track(e) {
                try {
                    if (!this.hasRequiredConsent()) return;
                    const t = { ...e,
                        shopId: Bo(this, oi)[oi].shopId,
                        source: this.constructSource(e.surface),
                        analyticsAllowed: Bo(this, oi)[oi].analyticsProcessingAllowed(),
                        marketingAllowed: Bo(this, oi)[oi].marketingAllowed(),
                        preferencesAllowed: Bo(this, oi)[oi].preferencesProcessingAllowed(),
                        saleOfDataAllowed: Bo(this, oi)[oi].saleOfDataAllowed(),
                        assetVersionId: Ge,
                        facebookCapiEnabled: !1,
                        shopifyEmitted: !0
                    };
                    Bo(this, ri)[ri]($t("webPixelsStorefrontCustomerTracking", t))
                } catch (t) {}
            }
            hasRequiredConsent() {
                return Bo(this, oi)[oi].analyticsProcessingAllowed() || Bo(this, oi)[oi].marketingAllowed()
            }
            constructSource(e) {
                return `wpm-${e}`
            }
        ...
        let si;
        const ai = Object.values(b),
            ci = e => {
                const t = e.trim().toLowerCase();
                return n = t, ai.includes(n) ? t : b.NotAvailable;
                var n
            },
            ui = Object.values(m),
            li = [m.NotAvailable, m.Unknown, m.StorefrontRenderer],
            di = e => {
                if (!e) return -1;
                const t = e.trim();
        ...
        const fi = () => {
            const e = (() => {
                ...
                t = (e => {
                    const t = e.trim().toLowerCase();
                    return n = t, ui.includes(n) ? t : window.Shopify ? .Checkout ? m.Shopify : window.Shopify ? .analytics ? .replayQueue ? m.StorefrontRenderer : window.CardFields ? m.CheckoutOne : m.Unknown;
                    var n
                })(e ? .surface ? ? ""),
                n = (e => {
                    if (!e) return [];
            ...
            return {
                browserTarget: ci(e ? .browserTarget ? ? ""),
                surface: t,
                enabledBetaFlags: n,
                ...
                events: pi(e ? .events),
                features: {
                    domEvents: !r && "false" !== e ? .domEvents && li.includes(t),
                    advancedDomEvents: !r && "false" !== e ? .advancedDomEvents,
                    storefrontEvents: "false" !== e ? .storefrontEvents && li.includes(t),
                    cartPermalink: "false" !== e ? .cartPermalink && [...li, m.CheckoutOne, m.Shopify].includes(t)
                },
                scope: {
                    publish: e ? .publish === nr.All ? nr.All : nr.Custom
                }
            }
        };
        try {
            ! function({
                ...
                pt.metadata = hn(t, ["shopId", "surface", "browserTarget", "shopDomain"]);
                try {
                    (({
                        storefrontBaseUrl: e
                    }) => {
                        if (!e) throw new lt("storefrontBaseUrl is required.");
                        if (! function(e) {
                                try {
                                    return new URL(e), !0
                                } catch (t) {
                            ...
                            }(e)) throw new lt(`storefrontBaseUrl is not a valid absolute URL: "${e}"`)
                    })(t), Lt(t.storefrontBaseUrl),
                        function(e = []) {
                            (Array.isArray(e) ? e : [e]).forEach((e => xt.add(e)))
                        }(t.enabledBetaFlags);
                    const c = n ? ? ((e, {
                            onError: t
                        } = {}) => {
                            const n = [new Fo(new Xo(qt, { ...e,
                                analyticsProcessingAllowed: $e,
                                marketingAllowed: je,
                                preferencesProcessingAllowed: Me,
                                saleOfDataAllowed: Ue
                            ...
                            return _t("f12a06f7") && n.push(new ni(new ii(qt, { ...e,
                                analyticsProcessingAllowed: $e,
                                marketingAllowed: je,
                                preferencesProcessingAllowed: Me,
                                saleOfDataAllowed: Ue
                    ...
                    if (self[Ke]) {
                        ...
                        const n = new f(`WebPixelsManager: ${Ke} global object is already defined`, {
                    ...
                    const S = $t("load", {
                        ...
                        k = {
                            init(n) {
                                if (function() {
                                        const e = `\\/(${kt.Wpm}|${kt.WebPixels})@(.+)\\/sandbox`;
                                ...
                                const {
                                    ...
                                    isMerchantRequest: d,
                                    monorailRegion: b,
                                    webPixelsConfigList: y
                                } = n, S = { ...n,
                                    ...t
                                };
                                if (si) return pt.notify(new f(`WebPixelsManager: ${Ke} is being initialized multiple times`, {
                                ...
                                const k = function() {
                                    ...
                                    return n.reverse().reduce(((e, t) => {
                                        const n = "" === e ? t : `${t}.${e}`;
                                        return function(e) {
                                                ln(`${pn}=1; path=/; domain=${e}`)
                                            }(n), dn(pn) || r.push(n),
                                            function(e) {
                                                ln(`${pn}=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT; domain=${e}`)
                                            }(n), n
                                    }), ""), fn.set(e, r), r
                                }();
                                d && Qe((() => self.sessionStorage.setItem(et, "true"))), Fe(), zt = b, (Qe((() => "true" === self.sessionStorage.getItem(et)), !1) || h === m.CustomerAccount) && Zn.init(S);
                                const C = Ne().toString(),
                                    A = $t("unload", {
                                        version: Xe,
                                        bundleTarget: Ye,
                                ...
                                var I;
                                I = A, window.addEventListener("pagehide", (() => {
                                    I.payload.pageDuration = It("page:session") ? .measurement ? .duration, Ut = !0, qt(I), Vt()
                                }));
                                const P = Lr(_),
                                    O = function(e) {
                                        const t = new Qn({
                                        ...
                                        return t.use(Ir), {
                                            publish(e, n, r) {
                                                ...
                                                if (e !== V) throw new f(`Expected event name to be a ${V}, but got "${e}".`, {
                                                    groupingHash: "CustomerPrivacyEventBus:PublishEventNameNotSupported"
                                                });
                                                return t.publish(e, n, r)
                                            },
                                            subscribe(n, r, o = {}) {
                                                if (n !== V) throw new f(`Event name "${n}" is not supported in the CustomerPrivacyEventBus.`, {
                                                    groupingHash: "CustomerPrivacyEventBus:SubscribeEventNameNotSupported"
                                                });
                                                return t.subscribe(n, (t => {
                                                    if (e === m.CheckoutOneSdk && o.scope !== er.CheckoutOneSdk) return;
                                                    const n = {
                                                    ...
                                                    r.call(t, t), Wt("subscriberEventEmitPrivacy", {
                                                        version: Xe,
                                                        bundleTarget: Ye,
                                                        pageUrl: self.location.href,
                                                        shopId: o.shopId,
                                ...
                                try {
                                    if (self.Shopify && !0 === self.Shopify.designMode) return self.console && console.log("[WebPixelsManager] Prevented from executing in the Theme Editor"), Lo;
                                    if (/^web-pixel-sandbox/.test(self.name)) {
                                        const e = new lt("WebPixelsManager: browser library is being run in a sandbox");
                                        throw pt.notify(e, { ...T,
                                            type: "metric",
                                            library: "browser"
                                        }), e
                                    }
                                    h === m.CheckoutOneSdk && (y.length = 0);
                                    const n = y.reduce(((e, t) => {
                                    ...
                                    Promise.all(n.ready).then((() => function(e) {
                                        ...
                                        function() {
                                            if (!gt) try {
                                                document.addEventListener(V, vt), gt = !0
                                            } catch (a) {
                                                pt.notify(a, {
                                    ...
                                    const s = (h === m.CustomerAccount ? P.publish : P.publishDomEvent).bind(P);
                                    if (w.storefrontEvents) try {
                                        ! function(e, t, n) {
                                            ...
                                            filterRemoteProducts: _t("2dca8a86")
                                        })
                                    } catch (a) {
                                        pt.notify(a, {
                                    ...
                                    return w.cartPermalink && function(t, {
                                    ...
                                    }(P.publish.bind(P), c), w.domEvents && No(s), w.advancedDomEvents && y.some((({
                                        capabilities: e
                                    }) => (e || []).includes(g.AdvancedDomEvents))) && (D = s, Mo.map((e => {
                                        try {
                                            return e(D)
                                        } catch (a) {
                                            return pt.notify(a, {
                                    ...
                                    })), N.payload.status = "initialized", qt(N), si = function(e, {
                                        eventBus: t,
                                        customerId: n,
                                        scope: r
                                    }) {
                                        const o = function({
                                            ...
                                            a = (e, n, o) => !(s === m.CustomerAccount && !l(e) && r.publish !== nr.All) && t.publish(e, n, o);
                                        return {
                                            ...
                                            subscribe: (e, n, r) => t.subscribe(e, n, { ...r,
                                                shopId: i,
                                                surface: s,
                                                scope: s === m.CheckoutOneSdk ? er.CheckoutOneSdk : void 0
                                            }),
                                        ...
                                        try {
                                            h === m.CustomerAccount || u(e) ? P.publish(e, t, n) : P.publishCustomEvent(e, t, n)
                                        } catch (a) {
                                            pt.notify(a, {
                                    ...
                                    return a instanceof lt || pt.notify(a, {
                                        context: "init",
                                        initConfig: S
                                    }), self.console && console.error(a), N.payload.status = "failed", N.payload.errorMsg = a ? .message, qt(N), A.payload.runtimeErrorCaught = "true", Lo
                                }
                                var D
                            }
                        };
                    ...
                    const e = a instanceof lt || "WebPixelsHandledError" === a.name;
                    return pt.notify(a, {
                        context: "createWebPixelsManager",
                        severity: e ? "warning" : "error",
                        unhandled: !e
                    }), self.console && console.error(a), qt($t("load", {
                        version: Xe,
                        bundleTarget: Ye,
                        pageUrl: s,
