! function() {
    var e = {
            ...
            8680: function(e, t, n) {
                ...
                t.storefrontApiUpdateTrackingConsent = function(e, t) {
                    ...
                    return fetch(`https://${p}/api/unstable/graphql.json`, f).then((e => {
                        ...
                        return h && i.cacheConsent(h), n.headlessStorefront && (r.writeCookie(i.CONSENT_COOKIE_NAME, E, p, h), g && C && (r.writeCookie(u, E, _, g), r.writeCookie(d, E, _, C)), v !== E && (r.writeCookie(i.CONSENT_COOKIE_NAME, v, p, h), g && C && (r.writeCookie(u, v, _, g), r.writeCookie(d, v, _, C)))), o.dispatchEvents(e), c.appendConsentToCustomerAccountLinks(m), void 0 !== t && t(null, a), a
                    })).catch((e => {
                ...
                var y = function(e) {
                    ...
                    return r(n, e), n.prototype.name = function() {
                        ...
                        return i(i({
                            ...
                            asset_version_id: "308893168db1679b4a9f8a086857af995740364f",
                        ...
                        var t = C.default.isEnabled(C.F_AD_UPFUNNEL_TRACKING),
                            n = T.getRemoteProductsEnabled();
                        if (!t || !n) return a.ALLOW;
                        var o = g.isRemoteProduct(e);
                        return !0 === o ? a.FILTER : null === o ? a.BLOCK : a.ALLOW
                    }, n.defaultOptions = {
                ...
                var a = n(8416),
                    ...
                    f = function(e) {
                        function t(t, n, o) {
                            ...
                            return r.defaultAttributes = l.default.attributes, r
                        }
            ...
            3811: function(e, t) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.F_AD_UPFUNNEL_TRACKING = t.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION = t.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS = t.TREKKIE_COOKIE_DOMAIN_FIX = void 0;
                var n = new(function() {
                    function e() {
                        this.betaFlagsProps = []
                    }
                ...
                t.TREKKIE_COOKIE_DOMAIN_FIX = "65f19447", t.TREKKIE_GOOGLE_CONSENT_MODE_WITH_CONSENT_SIGNALS = "6ebf83d2", t.SERVER_EMITTED_ADD_TO_CART_NEW_REPORTIFY_MIGRATION = "bdb960ec", t.F_AD_UPFUNNEL_TRACKING = "f0df213a", t.default = n
            },
            4252: function(e, t, n) {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                ...
                function E(e) {
                    if (void 0 === o && (!d.default.isEnabled(d.TREKKIE_COOKIE_DOMAIN_FIX) || m(e)))
                        if (function() {
            ...
            1037: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToObserve()) {
                        var n = "308893168db1679b4a9f8a086857af995740364f",
                            o = null,
                            r = null,
                            i = null;
                        if (e.app_config) try {
                    ...
                    g = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            a.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "308893168db1679b4a9f8a086857af995740364f",
