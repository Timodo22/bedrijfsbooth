var privacyBanner = function(n) {
    ...
    function bn(n, e) {
        ...
        if (e && "_tracking_consent" === n && !window.localStorage.getItem("tracking_consent_fetched")) {
            ...
            return console.debug("_tracking_consent missing"),
                ...
                }(), window.localStorage.setItem("tracking_consent_fetched", "true"), bn(n, !1)
        }
    }
    ...
    function Cn(n, e, t, o) {
        if (!wn(o)) throw new TypeError("Cookie value is not correctly URI encoded.");
        if (!wn(n)) throw new TypeError("Cookie name is not correctly URI encoded.");
        var r = n + "=" + o;
        r += "; path=/", e && (r += "; domain=" + e), r += "; expires=" + new Date((new Date).getTime() + t).toUTCString(), document.cookie = r
    }

    function xn() {
        var n, e, t, o = ((t = null === (n = window.Shopify) || void 0 === n || null === (e = n.customerPrivacy) || void 0 === e ? void 0 : e.cachedConsent) ? hn(t) : void 0) || new URLSearchParams(window.location.search).get("_cs") || void 0 || bn(vn) || function() {
            try {
                var n, e = sn(null === (n = performance) || void 0 === n ? void 0 : n.getEntriesByType("navigation"), 1)[0],
                    t = null == e ? void 0 : e.serverTiming.find((function(n) {
                        return "_cmp" === n.name
                    })),
        ...
        if (void 0 !== o) return function(n) {
            ...
            if ("3" == e) return function(n) {
                ...
                function p(n) {
                    var e = a.split(".")[0];
                    return e.includes(n.toLowerCase()) ? x : e.includes(n.toUpperCase()) ? C : w
                }
                ...
                return {
                    v: "3",
                    con: {
                        CMP: X(X(X(X({}, O, p(O)), A, p(A)), E, p(E)), B, p(B))
                    },
                    region: i || "",
                    cus: e,
    ...
    function Kn(n, e, t) {
        ...
        return fetch("https://" + a + "/api/unstable/graphql.json", c).then((function(n) {
            ...
            }(p), o.headlessStorefront && (Cn(vn, u, c, p), f && h && (Cn(Gn, u, s, f), Cn(Jn, u, s, h)), d !== u && (Cn(vn, d, c, p), f && h && (Cn(Gn, d, s, f), Cn(Jn, d, s, h)))), Nn(e), Wn(m, n), void 0 !== t && t(null, r), r
        })).catch((function(n) {
    ...
    var Xn = function() {
        return K((function n(e) {
            ...
            key: "produce",
            value: function(n, e) {
                if (this.instrumentationEnabled() && Pn()) try {
                    var t = {
    ...
    function $n(n, e) {
        if ((new Xn).produce("setTrackingConsent", Ln), function(n) {
                ...
                if ("object" === un(n)) {
                    ...
                    for (var t = [T, P, S, M, R, H, L, N, F, j, W, q], o = 0, r = e; o < r.length; o++) {
                        var a = r[o];
    ...
    function ee() {
        return jn() ? "string" == typeof navigator.globalPrivacyControl ? "1" !== navigator.globalPrivacyControl : "boolean" == typeof navigator.globalPrivacyControl ? !navigator.globalPrivacyControl : null : null
    }
    ...
    function le(n, e, t) {
        try {
            ...
            ! function(n) {
                var e = new XMLHttpRequest;
                e.open("POST", "https://error-analytics-production.shopifysvc.com", !0), e.setRequestHeader("Content-Type", "application/json"), e.setRequestHeader("Bugsnag-Api-Key", se), e.setRequestHeader("Bugsnag-Payload-Version", "5");
                var t = function(n) {
                    var e = function(n) {
    ...
    function xe(n) {
        return void 0 === n && (n = {
            ...
            function(n) {
                ...
                var r = ["unstable"];
                for (var a in o) o.hasOwnProperty(a) && (o[a] = r.includes(a) ? o[a] : ue(o[a]));
                return o
            }(n)
    }! function(n) {
    ...
    function De(n, e, t, o, r) {
        var a = "0,0,0,100",
            ...
            l = _e(null != e ? e : a, null != t ? t : i, null != o ? o : a, null != r ? r : i),
            u = function() {
                switch (n) {
                    case ge.Light:
                        return c;
    ...
    function Ee(n) {
        var e = n.bannerData,
            t = n.selectorPrefix,
            o = t ? "".concat(t, " ") : "",
            r = De(e.theme.theme, e.theme.fontColor, e.theme.backgroundColor, e.theme.buttonFontColor, e.theme.buttonBackgroundColor),
            a = function(n, e, t) {
                var o = "1280px",
    ...
    function Ae(n, e, t) {
        ...
        try {
            ! function(n) {
                var e = new XMLHttpRequest;
                e.open("POST", "https://error-analytics-production.shopifysvc.com", !0), e.setRequestHeader("Content-Type", "application/json"), e.setRequestHeader("Bugsnag-Api-Key", Oe), e.setRequestHeader("Bugsnag-Payload-Version", "5");
                var t = function(n) {
                    var e = function(n) {
                            return n.stackTrace || n.stack || n.description || n.name
                        }(n.error),
                ...
                error: n,
                context: e,
                shopId: Be() || (null === (o = window.Shopify) || void 0 === o ? void 0 : o.shop),
                notes: t
            })
        } catch (n) {}
    }
    ...
    var Se = function() {
        ...
        Re = function() {
            var n, e = Rn() && Se();
            return !window.location.pathname.match(/\/password$/) && (n = window.location.hostname || window.location.host || "", !Me.some((function(e) {
        ...
        He = function() {
            var n;
            return Boolean(!0 === (null === (n = null === window || void 0 === window ? void 0 : window.Shopify) || void 0 === n ? void 0 : n.previewMode)) && Se()
        },
        Le = function() {
            return je() || He()
        },
                            ...
                            case 2:
                                if ((i = o.sent()).errors) {
                                    if ((c = i.errors.find((function(n) {
                                        ...
                                        }))) && !n) return s = c.message || "", l = s.includes("Directive 'inContext'") && s.includes("invalid value"), window.Weglot || l ? console.log("Banner localization error", c.message) : Ae(new Error(c.message), "DataFetching"), [2, this.getDataFromStorefrontApi(!0)];
    ...
    function qe(n) {
        for (var e = 1; e < arguments.length; e++) {
            ...
            e % 2 ? We(Object(t), !0).forEach((function(e) {
                Fe(n, e, t[e])
            })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t)) : We(Object(t)).forEach((function(e) {
    ...
    var $e = function(n) {
        ...
        Qe = function() {
            function n(n, e) {
                void 0 === n && (n = Ue), void 0 === e && (e = !1), this.edgeDomain = n, this.keepalive = e
            }
            return K(n, [{
                key: "produceBatch",
                    ...
                    return pn().wrap((function(n) {
                        for (;;) switch (n.prev = n.next) {
                            ...
                            case 4:
                                ...
                                break;
                            case 7:
                                throw n.prev = 7, n.t0 = n.catch(1), new Ye(n.t0);
                            case 10:
                                if (207 !== o.status) {
                                    n.next = 15;
                                    break
                            ...
                            case 15:
                                ...
                                return n.t1 = $e, n.t2 = o.status, n.next = 20, o.text();
                            case 20:
                ...
                value: (e = J(pn().mark((function n(e) {
                    ...
                    return pn().wrap((function(n) {
                        for (;;) switch (n.prev = n.next) {
                            case 0:
                                return t = !0, e && e.options && Object.prototype.hasOwnProperty.call(e.options, "convertEventCase") && (t = Boolean(e.options.convertEventCase)), n.prev = 2, n.next = 5, et({
                            ...
                            case 5:
                                ...
                                break;
                            case 8:
                                throw n.prev = 8, n.t0 = n.catch(2), new Ye(n.t0);
                            case 11:
                                if (o) {
                                    n.next = 13;
                                    break
                            ...
                            case 13:
                                ...
                                return n.t1 = $e, n.t2 = o.status, n.next = 18, o.text();
                            case 18:
                                throw n.t3 = n.sent, n.t4 = {
                                    status: n.t2,
                                    message: n.t3
    ...
    function nt(n) {
        var e = {
            ...
            "X-Monorail-Edge-Client-Message-Id": (n && n.clientMessageId || Ve()).toString()
        };
    ...
    function tt() {
        return (tt = J(pn().mark((function n(e) {
            var t, o, r;
            return pn().wrap((function(n) {
                for (;;) switch (n.prev = n.next) {
                    case 0:
                        return t = e.endpoint, o = e.event, r = e.keepalive, n.abrupt("return", fetch(null != t ? t : ze + Ge, {
                            method: "post",
    ...
    var ot, rt, at, it, ct = function() {
        ...
        st = function() {
            function n(e, t) {
                this.producer = e, this.middleware = t, this.executeChain = n.buildMiddlewareChain(this.middleware.concat(new Je(e)))
            }
            return K(n, [{
                key: "produce",
                value: function(n) {
                    return n.metadata = qe({
                ...
                value: function(e) {
                    ...
                    return new n(e.production ? new Qe(ze, t) : new Qe(Ue, t), e.middleware || [])
                }
            }, {
        ...
        lt = function() {
            function n(n) {
                var e = void 0 === n ? {} : n,
                    t = e.shopDomain,
                    o = e.isHeadless;
                this.VISIT_TOKEN = "_shopify_s", this.shopDomain = t, this.isHeadless = o, this.monorail = st.createHttpProducer({
                    production: !0
                })
            }
    ...
    function ft(n) {
        var e, t = ut(document.createElement("button"), n);
    ...
    function Ct(n) {
        ...
        o.appendChild(r);
        var a = dt({
            class: be.ButtonsClass
        });
        return a.classList.add(be.ButtonsGranularClass), o.appendChild(a),
            function(n, e) {
                if (n.title) {
                    var t = yt({
                        id: be.BodyTitleId,
    ...
    function xt(n, e) {
        var t, o, r, a, i = (t = {
            appendTo: n
        }, ut(document.createElement("header"), t));
        o = i, r = "Close dialog", bt({
            appendTo: a = ft({
                id: we.HeaderCloseId,
        ...
        var c = dt({
            class: we.HeaderActionsClass,
            appendTo: i
        });
        return function(n, e) {
                n.appendChild(ft({
                    id: we.HeaderAcceptId,
                    type: "button",
                    text: e
                }))
    ...
    function kt(n, e) {
        ...
        return function(n, e) {
            ...
            var t = dt({
                    class: we.IntroExplainWrapperClass,
                    appendTo: n
                }),
                o = dt({
                    class: we.IntroExplainAcceptClass,
                    appendTo: t
                });
            gt({
    ...
    function _t(n) {
        ...
        d.appendChild(s), d.appendChild(c), ht({
            appendTo: l,
    ...
    function It(n) {
        var e = n.bannerData,
            t = dt({
                id: we.WrapperId,
                class: we.WrapperClass
            }),
            o = dt({
                id: we.OverlayId,
                class: we.OverlayClass,
                text: " "
            });
        t.appendChild(o);
        var r = wt({
        ...
        var a = dt({
            class: we.DialogScrollableClass
        });
        return r.appendChild(a), kt(a, e),
            function(n, e) {
                var t = De(e.theme.theme, e.theme.fontColor, e.theme.backgroundColor, e.theme.buttonFontColor, e.theme.buttonBackgroundColor),
                    o = dt({
                        class: we.OptionWrapperClass
                    });
                n.appendChild(o), _t({
                    themeColours: t,
                    ids: {
    ...
    var Dt = function() {
            function n(n) {
                ...
                this.bannerData = e, t ? (this.storefrontAccessToken = t, this.checkoutRootDomain = o, this.storefrontRootDomain = r, this.logger = new lt({
                    shopDomain: o,
                    isHeadless: !0
                })) : this.logger = new lt
            }
            return n.show = function() {
                ...
                this.addCSS(this.bannerData), this.addHTML(this.bannerData), this.previouslyFocusedElement = document.activeElement, n.show(), this.setupCheckboxEventHandlers(), this.setupButtonEventHandlers(), this.setupKeyboardEventHandlers(), this.logger.emitInteraction(ot.ManagePreferences)
                ...
                l ? (d.style.display = "block", p.style.display = "none") : (d.style.display = "none", p.style.display = "block"), i = n.selectedConsent(), c = document.getElementById(we.DialogId), s = document.getElementById(we.HeaderSaveId), (null == c ? void 0 : c.dataset.consent) && (null == c ? void 0 : c.dataset.consent) !== i ? s.className = "primary" : s.className = ""
                ...
                null == t || t.addEventListener("click", (function() {
                    n.hide(e.previouslyFocusedElement), e.logger.emitInteraction(ot.LeavePreferences)
                }));
                ...
                null == o || o.addEventListener("click", (function() {
                    if (je()) n.hideModalAndBanner(e.previouslyFocusedElement);
                        ...
                        }), e.logger.emitInteraction(ot.Save, "".concat(a ? "m" : "").concat(i ? "a" : "").concat(c ? "p" : ""))
                    }
                }));
                var r = document.getElementById(we.HeaderAcceptId);
                null == r || r.addEventListener("click", (function() {
                    je() ? n.hideModalAndBanner(e.previouslyFocusedElement) : (Pe({
                        marketing: !0,
                        analytics: !0,
                        preferences: !0,
                        checkoutRootDomain: e.checkoutRootDomain,
                ...
                e.key === it.Escape && (n.hide(this.previouslyFocusedElement), this.logger.emitInteraction(ot.LeavePreferences))
        ...
        Et = function() {
            function n(n) {
                ...
                var c = t;
                c && (this.checkoutRootDomain = o, this.storefrontRootDomain = r), this.logger = new lt({
                    shopDomain: o,
            ...
            return n.show = function() {
                ...
                return t(this, arguments, void 0, (function(t) {
                    ...
                    return void 0 === t && (t = !1), o(this, (function(o) {
                        switch (o.label) {
                            case 0:
                                return o.trys.push([0, 3, , 4]), [4, Ne.getServerData(this.checkoutRootDomain, this.storefrontAccessToken, this.locale, this.country)];
                            case 1:
                                return (r = o.sent()) && Object.keys(r).length ? [4, "loading" !== document.readyState ? Promise.resolve() : new Promise((function(n) {
                                    document.addEventListener("DOMContentLoaded", n)
                                }))] : (console.warn("banner not rendered due to lack of saved data"), [2, Promise.resolve(!1)]);
                            case 2:
                                return o.sent(), this.removeExistingElements(), this.render(e({}, r)), t && (this.preferencesModal = new Dt({
                                    bannerData: r,
                            ...
                            case 3:
                                return a = o.sent(), this.removeExistingElements(), [2, Promise.reject(a)];
                            case 4:
                                return [2]
                        }
                    }))
                ...
                var t = e.enabled,
                    ...
                    a = je() || r || t;
                a && !document.getElementById(be.DialogId) && (this.addCSS(e), this.addBannerHTML(e)), a && Re() && (n.show(), He() || this.logger.emitRender())
            }, n.prototype.isCountryInRegionVisibility = function(n, e) {
                var t;
                return null === (t = e.regionVisibility) || void 0 === t ? void 0 : t.includes(n)
            }, n.prototype.addCSS = function(n) {
                var e = vt({
                    id: be.StylesContainerId,
                    content: Ee({
                        bannerData: n
                    })
                });
                ...
                var n, e, t, o, r = document.getElementById(be.DialogId),
                ...
                var e = this;
                this.addEssentialEventListeners(), je() || this.addMetricsEventListeners();
                var t = document.getElementById(be.ButtonManagePrefsId);
                null == t || t.addEventListener("click", (function(t) {
                    t.preventDefault(), e.preferencesModal = new Dt({
                        bannerData: n,
                        storefrontAccessToken: e.storefrontAccessToken,
                        checkoutRootDomain: e.checkoutRootDomain,
                        storefrontRootDomain: e.storefrontRootDomain
    ...
    function At(n, e) {
        var t, o = n.target;
        (null == (t = o) ? void 0 : t.closest('a[href$="'.concat(Ot, '"]'))) && e(n)
    }
                ...
                return d || (d = window.location.hostname), p || (p = window.location.hostname), y || (y = null === (i = null === window || void 0 === window ? void 0 : window.Shopify) || void 0 === i ? void 0 : i.locale), g || (g = null === (c = null === window || void 0 === window ? void 0 : window.Shopify) || void 0 === c ? void 0 : c.country), e = function() {
                    return t(s, void 0, void 0, (function() {
                        ...
                        return o(this, (function(o) {
                            switch (o.label) {
                                case 0:
                                    return o.trys.push([0, 3, , 4]), n = Boolean(u), e = new lt({
                                        shopDomain: d,
                                        isHeadless: n
                                    }), !(Le() || Re() || h) || function() {
                                        var n;
    ...
    function Tt(n) {
        n && (window.Shopify = window.Shopify || {}, window.Shopify.customerPrivacy && window.Shopify.trackingConsent || (window.Shopify.customerPrivacy = window.Shopify.trackingConsent = xe()))
    }
    ...
    function Pt() {
        return t(this, arguments, void 0, (function(n) {
            return void 0 === n && (n = {}), o(this, (function(t) {
                switch (t.label) {
                    case 0:
                        return Tt(Boolean(n.storefrontAccessToken)), [4, Bt(e(e({}, n), {
                            showPreferences: !0
                        }))];
                    case 1:
                        return t.sent(), [2]
    ...
    }(), n.loadBanner = Bt, n.showPreferences = Pt, n
}({});